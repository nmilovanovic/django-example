...
# Data arrays
MALE_NAMES = ["Nikola", "Marko", "Stefan", "Luka", "Aleksandar", "Jovan", "Nemanja", "Miloš", "Filip", "Dušan"]
FEMALE_NAMES = ["Milica", "Jelena", "Katarina", "Marija", "Ana", "Jovana", "Teodora", "Anđela", "Sofija", "Sara"]
SURNAMES = ["Jovanović", "Petrović", "Nikolić", "Marković", "Đorđević", "Stojanović", "Ilić", "Stanković", "Pavlović", "Milošević"]
STREETS = ["Knez Mihailova", "Bulevar kralja Aleksandra", "Nemanjina", "Kralja Milana", "Takovska", "Gospodar Jovanova", "Bulevar oslobođenja", "Njegoševa"]
CITIES = ["Beograd", "Novi Sad", "Niš", "Kragujevac", "Subotica", "Zrenjanin", "Pančevo", "Čačak", "Kraljevo", "Novi Pazar"]
...
SCHOOLS = [
    ...
    ("Elektrotehnička škola 'Nikola Tesla'", "Kraljice Natalije 31, Beograd", "Belgrade"),
    ("Vazduhoplovna akademija", "Bulevar vojvode Bojovića 2, Beograd", "Belgrade"),
    ("Gimnazija 'Svetozar Marković'", "Branka Radičevića 1, Niš", "Southern and Eastern Serbia"),
    ("Gimnazija 'Bora Stanković'", "Vožda Karađorđa 27, Niš", "Southern and Eastern Serbia"),
    ("Zemunska gimnazija", "Gradski park 1, Beograd", "Belgrade"),
    ("Deseta beogradska gimnazija 'Mihajlo Pupin'", "Antifašističke borbe 71, Beograd", "Belgrade"),
    ("Medicinska škola", "Radoja Domanovića 1, Kragujevac", "Šumadija and Western Serbia"),
]
...
def generate_email(first_name, last_name, counter):
    ...
    first_clean = first_name.replace("đ", "dj").replace("Đ", "Dj").replace("č", "c").replace("ć", "c").replace("ž", "z").replace("š", "s")
    last_clean = last_name.replace("đ", "dj").replace("Đ", "Dj").replace("č", "c").replace("ć", "c").replace("ž", "z").replace("š", "s")
